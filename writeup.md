...
Here is the disassembly of [`getVerificationToken`](https://github.com/pvrs12/casperapi/blob/master/disassembly.asm#L68)
...
###sub_9B0
Here is the disassembly of [`sub_9B0`](https://github.com/pvrs12/casperapi/blob/master/disassembly.asm#L495)
...
###sub_740
Here is the disassembly of [`sub_740`](https://github.com/pvrs12/casperapi/blob/master/disassembly.asm#L276)
...
###sub_CA0
Here is the disassembly of [`sub_CA0`](https://github.com/pvrs12/casperapi/blob/master/disassembly.asm#L716)
...
###sub_13C0
Here is the disassembly for [`sub_13C0`](https://github.com/pvrs12/casperapi/blob/master/disassembly.asm#L1208)
...
This parameter list must be alphabetized as that's how Casper's API expect's it. 
